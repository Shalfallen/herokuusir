...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="small-box bg-purple">
            <div class="inner">
                ...
                <div style="display:none">{{ $val += $data }}</div>
                @endforeach
    ...
    <div class="col-lg-12">
        ...
        <div class="small-box bg-yellow">
            <div class="inner">
                <h3>{{'Rp. ' . number_format($data_pendapatan[date('d') -1]) }}</h3>
    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Grafik Pendapatan [bulanan] {{ tanggal_indonesia($tanggal_awal, false) }} s/d {{ tanggal_indonesia($tanggal_akhir, false) }}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
